...
tellraw @a [{"text": "═════════[ ", "color": "#19df5", "bold": true}, {"text": "Welcome Message", "color": "light_purple"}, {"text": " ]═════════"}]
tellraw @a ""
tellraw @a [{"text": "Version", "color": "gray"}, {"text": ": ", "color": "yellow"}, {"text": "0.0.2", "color": "aqua"}]
...
execute as @a run function src:cmd/tlw/mess/help
